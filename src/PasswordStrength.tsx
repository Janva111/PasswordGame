...
const PasswordStrength: React.FC<Props> = ({
    ...
    const rules = [
        ...
        // Opraveno: Pravidla nyní správně reagují na externí data předaná z props
        ...
        { id: 8, label: `Heslo musí obsahovat zkratku této země:`, check: () => isCountryValid, isCountryRule: true },
    ];

    // Najde první nesplněné pravidlo
    const firstUnmetIndex = rules.findIndex(rule => !rule.check(password));
    // Zobrazí všechna splněná pravidla + jedno první nesplněné
                ...
                {[...visibleRules].reverse().map((rule) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {rule.isCountryRule && selectedCountry && (
                                <div style={{ marginTop: '10px', textAlign: 'center' }}>
                                    <img
                                        src={`https://flagsapi.com/${selectedCountry.toUpperCase()}/flat/64.png`}
